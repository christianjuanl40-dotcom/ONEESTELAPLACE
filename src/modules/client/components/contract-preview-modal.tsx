...
export function ContractPreviewModal({
  ...
  const officeBooking = booking ? isOfficeBooking(booking) : false
  const contractFile = (officeBooking
    ? cmsData?.officeRentalContract
    : cmsData?.eventVenueContract) || { fileName: "", fileType: "", fileUrl: "" }
  const hasContract = Boolean(contractFile.fileUrl && contractFile.fileName)
